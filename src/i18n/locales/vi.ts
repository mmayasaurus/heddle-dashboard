...
const vi: typeof en = {
  ...
  "fleet.title": "Đội", "fleet.refresh": "Làm mới", "fleet.capsWaiting": "giới hạn: đang chờ thanh trạng thái hiển thị…", "fleet.usageUnavailable": "không có dữ liệu sử dụng", "fleet.noActiveWindow": "không có cửa sổ hoạt động", "fleet.capturedMinutesAgo": (n) => `đã ghi nhận ${n} phút trước`, "fleet.stale": "cũ", "fleet.limitReached": "đã đạt giới hạn", "fleet.resetting": "đang đặt lại…", "fleet.currentProject": "Dự án hiện tại", "fleet.allAgents": "Tất cả tác nhân", "fleet.loggedOut": "đã đăng xuất — cần /login", "fleet.keeperEstimate": "cửa sổ đang hoạt động (ước tính keeper) — % xuất hiện sau lần hiển thị đầu tiên của tài khoản này",
