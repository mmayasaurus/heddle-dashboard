...
const en = {
  ...
  "fleet.capsWaiting": "caps: waiting for a statusline render…",
  "fleet.usageUnavailable": "usage unavailable",
  ...
  "fleet.hudModel": (model: string) => `model ${model}`,
  "fleet.hudGit": (branch: string, dirty: boolean) => `git ${branch}${dirty ? " *" : ""}`,
  "fleet.hudContext": (pct: number) => `context ${pct}%`,
  "fleet.hudResources": (claudeMd: number, rules: number, mcp: number) => `CLAUDE.md ${claudeMd} · rules ${rules} · MCP ${mcp}`,
  "fleet.hudAge": (age: string) => `${age} ago`,
  "fleet.hudSeparator": " · ",
  ...
  "fleet.comms.operatorHintNoBinary": "Install heddle to enable the operator composer.",
  "fleet.comms.operatorHintNoToken": "Run heddle-comms --init-operator-token to enable sending.",
  "fleet.comms.operatorHintRevoked": "Operator token was rotated — restart the app.",
  ...
  "fleet.comms.roomNameLabel": "Name",
  "fleet.comms.roomNamePlaceholder": "room-name",
  "fleet.comms.roomNameRequired": "Name is required.",
  "fleet.comms.roomTopicLabel": "Topic (optional)",
  "fleet.comms.roomMembersLabel": "Members",
  "fleet.comms.roomOpenLabel": "Open room",
  "fleet.comms.createRoom": "Create room",
  "fleet.comms.creating": "Creating…",
  "fleet.comms.membersFailed": (addresses: string) => `Failed to add: ${addresses}`,
  "fleet.comms.memberAddress": "Agent address",
  "fleet.comms.addMember": "Add",
  "fleet.comms.removeMember": "Remove",
