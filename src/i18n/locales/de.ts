...
const de: typeof en = {
  ...
  "fleet.title": "Flotte", "fleet.refresh": "Aktualisieren", "fleet.capsWaiting": "Limits: Warte auf Statusleisten-Rendern…", "fleet.usageUnavailable": "Nutzung nicht verfügbar", "fleet.noActiveWindow": "kein aktives Fenster", "fleet.capturedMinutesAgo": (n) => `vor ${n} Min. erfasst`, "fleet.stale": "veraltet", "fleet.idle": "inaktiv", "fleet.idleHint": "5h/7d werden nur aktualisiert, während dieses Konto eine Sitzung steuert", "fleet.limitReached": "Limit erreicht", "fleet.resetting": "wird zurückgesetzt…", "fleet.currentProject": "Aktuelles Projekt", "fleet.allAgents": "Alle Agents", "fleet.loggedOut": "abgemeldet — /login erforderlich", "fleet.keeperEstimate": "Fenster aktiv (keeper-Schätzung) — % erscheint nach dem ersten Rendern dieses Kontos", "fleet.loginUnknown": "Anmeldestatus unbekannt", "fleet.rotateAccounts": "Konten wechseln", "fleet.fableWeekly": (pct) => `Fable ≈${pct}% des Wochenlimits (geschätzt)`, "fleet.fableWeeklyExact": (pct) => `Fable ${pct}% des Wochenlimits`, "fleet.fableWeeklyEstMark": "gesch.", "fleet.fableWeeklyBreakdown": (fable, other, unknown, samples) => `Fable ${fable}% · andere ${other}% · unbekannt ${unknown}% · ${samples} Stichproben`, "fleet.hudModel": (model) => `Modell ${model}`, "fleet.hudGit": (branch, dirty) => `Git ${branch}${dirty ? " *" : ""}`, "fleet.hudContext": (pct) => `Kontext ${pct}%`, "fleet.hudResources": (claudeMd, rules, mcp) => `CLAUDE.md ${claudeMd} · Regeln ${rules} · MCP ${mcp}`, "fleet.hudAge": (age) => `vor ${age}`, "fleet.hudSeparator": " · ",
  ...
  "titlebar.browser": "Integrierter Browser (⌘⇧B)", // Built-in Browser (⌘⇧B)
  ...
  "share.title": "heddle teilen", // Share heddle
  "share.subtitle":
    "Hinter heddle steht ein kleines Team. Wenn es dir gefällt, teile heddle bitte mit anderen. Dass dadurch mehr Menschen von uns erfahren, bedeutet unserem Team sehr viel. Danke für deine Unterstützung! ❤️", // We're a small team behind heddle. If you enjoy it, please share heddle with others…
  ...
  "connect.desc":
    "Adresse und Passwort eines entfernten heddle eingeben, um es in einem neuen Fenster zu verbinden und zu steuern.", // Enter the address and password…
  ...
  "tree.newRoom": "Neuer Raum", // New room
  ...
  "tree.globalSearch": "Alle Sitzungen durchsuchen (⌘⇧F)", // Search All Sessions (⌘⇧F)
  ...
  "agentInstall.desc": (label) =>
    `heddle hat ${label} nicht in Ihrem PATH gefunden. Installieren Sie es, um diese Sitzung zu starten.`, // couldn't find {label} on PATH
  ...
  "doc.saveTooltip": "Speichern (⌘S)", // Save (⌘S)
  "doc.externalChanged":
  ...
  "fleet.comms.targetUnavailable": "Chat-Ziel ist nicht verfügbar.",
