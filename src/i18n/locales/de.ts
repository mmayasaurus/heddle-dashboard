...
const de: typeof en = {
  ...
  "fleet.title": "Flotte", "fleet.refresh": "Aktualisieren", "fleet.capsWaiting": "Limits: Warte auf Statusleisten-Rendern…", "fleet.usageUnavailable": "Nutzung nicht verfügbar", "fleet.noActiveWindow": "kein aktives Fenster", "fleet.capturedMinutesAgo": (n) => `vor ${n} Min. erfasst`, "fleet.stale": "veraltet", "fleet.limitReached": "Limit erreicht", "fleet.resetting": "wird zurückgesetzt…", "fleet.currentProject": "Aktuelles Projekt", "fleet.allAgents": "Alle Agents", "fleet.loggedOut": "abgemeldet — /login erforderlich", "fleet.keeperEstimate": "Fenster aktiv (keeper-Schätzung) — % erscheint nach dem ersten Rendern dieses Kontos", "fleet.loginUnknown": "Anmeldestatus unbekannt", "fleet.rotateAccounts": "Claude-Konten wechseln",
